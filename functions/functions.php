...
function getBrandPro(){
	...
	$run_brands_pro = mysqli_query($con,$get_brand_pro);
	$count_brands = mysqli_num_rows($run_brands_pro);
	if($count_brands == 0)
	{
		echo"<h1 style='padding:20px;'>No product where found associated with this brand!</h1>";
	}
